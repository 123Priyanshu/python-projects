...
oneAtATime(0.5, " - What is your ... S P I R I T  D R I N K! -")
print()
print()
print("Here's the  Questions!")
questionBase('What is the BEST color out of all of these?', '1. Red', '2. Blue', '3. Green')
print()
questionBase('If you had a robot that could do one of these three tasks what would it be?', '1. Get it to do your work', '2. Make it follow you', '3. Scream whenever it sees you.')
print()
questionBase('Do you Read, or Believe in Horoscopes?', '1. No', '2. A little bit', '3. Obviously who does not!!')
print()
questionBase('An old lady walks in-front of you and pulls out a gun..What do you do?', "1. SCREAM...she gets scared and shoots you in the face. ",
             '2. try to take the gun, you have a 50% chance of successfully taking it', '3. RUN!')
print()
questionBase("You're thrown into war, what's your first move? ", '1. Try to Escape', '2. Try to fight off enemies', '3. Become a traitor')
print()
...
You appreciate the smaller attention to detail things and enjoy a bit of sweetness from time to time.''')
    ...
    for e in alchRange:
        if e == counter:
            print('Fruit Punch')
            print('''Ayyy we got a SECRET PARTY ANIMAL over here! You love to vibe out with your comrades and drink some punch.
You have a super lazed-back lifestyle, some people will hate you, others will love you.
Keep the party going, it’s all fun and games.''')
            check = False

    if counter >= 51:
        print("I don't know how you made this error happen, but it happened.")
        time.sleep(2)
        print("You are crusty, put some lotion on.")
        check = False
